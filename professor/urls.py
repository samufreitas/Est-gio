...
urlpatterns = [
    ...
    path('listar_plano_pro/<str:status>/', views.list_plano_pro, name='list_plano_pro_status'),
    ...
    path('listar_trabalho_pro/<str:status>/', views.list_trabalho_pro, name='list_trabalho_pro_status'),

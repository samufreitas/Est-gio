...
urlpatterns = [
    ...
    path('listar_plano_pro/<str:status1>/', views.list_plano_ori, name='list_plano_ori_status'),
    ...
    path('listar_plano_pro/<str:status1>/', views.list_trabalho_ori, name='list_trabalho_ori_status'),
